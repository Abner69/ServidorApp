...
--
-- Servidor: localhost
-- Tiempo de generación: 21-03-2022 a las 23:09:16
...
(12, 'Ulises', 'Lopez', 'Hernandez', 'Doctor', 5, 1, 'Computacion'),
(15, 'Ulises', 'Lopez', 'Guzman', 'Maestro', 6, 2, 'Diseño'),
(20, 'Gerardo', 'Aragon', 'Savedra', 'Maestro', 8, 7, 'Mecatronica'),
(26, 'Julissa', 'Bonola', 'Lopez', 'Doctora', 7, 8, 'Fisica');
...
(12, 'lopezhernandezu@gmail.com', '1234'),
(15, 'utm@gmail.com', '123'),
(20, 'lohu@gmail.com', '12'),
(26, 'jul@gmail.com', '109');
...
--
ALTER TABLE `Profesor`
  MODIFY `idProfesor` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
